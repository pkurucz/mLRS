...
//-- ELRS 2.4 GHz & 868/915 MHz Generic Devices (LR1121)
...
#ifdef RX_ELRS_GENERIC_C3_LR2021_ESP32C3
  #define DEVICE_NAME "GENERIC C3 LR2021"
  #define DEVICE_IS_RECEIVER
  ...
  #define DEVICE_NAME "GENERIC S2 LR2021"
  #define DEVICE_IS_RECEIVER
  #define DEVICE_HAS_LR20xx
  #define FREQUENCY_BAND_2P4_GHZ
  #define FREQUENCY_BAND_868_MHZ
...
#ifdef RX_ELRS_GENERIC_S3_LR2021_ESP32S3
  #define DEVICE_NAME "GENERIC S3 LR2021"
  #define DEVICE_IS_RECEIVER
  #define DEVICE_HAS_LR20xx
  #define FREQUENCY_BAND_2P4_GHZ
